...
import com.kevinvicente.argprogback.argprogback.dto.EducacionDto;
...
import com.kevinvicente.argprogback.argprogback.service.EducacionService;
...
public class EducacionController {
    ...
    public ResponseEntity<?> create(@RequestBody EducacionDto educacionDto) {
        ...
        Educacion educacion = new Educacion(educacionDto.getTituloEd(), educacionDto.getInstitucion(),
                educacionDto.getFechaInicio(), educacionDto.getFechaFin(), educacionDto.getDescripcionEd());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody EducacionDto educacionDto) {
        ...
        if (educacionService.existsByTituloEd(educacionDto.getTituloEd())
                && educacionService.getByTituloEd(educacionDto.getTituloEd()).get().getId() != id) {
