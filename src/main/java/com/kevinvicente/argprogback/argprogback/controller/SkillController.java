...
import com.kevinvicente.argprogback.argprogback.dto.SkillDto;
...
import com.kevinvicente.argprogback.argprogback.service.SkillService;
...
public class SkillController {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody SkillDto skillDto) {
        ...
        if (skillService.existsByNombreSk(skillDto.getNombreSk())
                && skillService.getByNombreSk(skillDto.getNombreSk()).get().getId() != id) {
