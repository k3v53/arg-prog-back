...
import com.kevinvicente.argprogback.argprogback.dto.PersonaDto;
import com.kevinvicente.argprogback.argprogback.entity.Persona;
import com.kevinvicente.argprogback.argprogback.security.controller.Mensaje;
import com.kevinvicente.argprogback.argprogback.service.PersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<?> create(@RequestBody PersonaDto personaDto) {
        ...
        Persona persona = new Persona(personaDto.getNombre(), personaDto.getApellido(), personaDto.getTitulo(),
                personaDto.getDescripcion(), personaDto.getImg());
        personaService.save(persona);
