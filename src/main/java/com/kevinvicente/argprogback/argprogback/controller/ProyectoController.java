...
import com.kevinvicente.argprogback.argprogback.dto.ProyectoDto;
...
import com.kevinvicente.argprogback.argprogback.service.ProyectoService;
...
public class ProyectoController {
    ...
    public ResponseEntity<?> create(@RequestBody ProyectoDto proyectoDto) {
        ...
        Proyecto proyecto = new Proyecto(proyectoDto.getTituloPr(), proyectoDto.getDescripcionPr(),
                proyectoDto.getImgPr(), proyectoDto.getRepositorio());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody ProyectoDto proyectoDto) {
        ...
        if (proyectoService.existsByTituloPr(proyectoDto.getTituloPr())
                && proyectoService.getByTituloPr(proyectoDto.getTituloPr()).get().getId() != id) {
